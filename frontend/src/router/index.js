...
const routes = [{
    ...
    },
    {
        ...
        name: 'FaceComparison',
        component: () =>
            import ('../views/FaceComparison.vue'),
    ...
    },
    {
        ...
        name: 'RegisterPerson',
        component: () =>
            import ('../views/RegisterPerson.vue'),
    ...
    },
    {
        ...
        name: 'ModelSettings',
        component: () =>
            import ('../views/ModelSettings.vue'),
    ...
    },
    {
        ...
        name: 'PoseEstimation',
        component: () =>
            import ('../views/PoseEstimation.vue'),
    ...
    },
    {
        ...
        name: 'ViolationLogs',
        component: () =>
            import ('../views/ViolationLogs.vue'),
    ...
    },
    {
        ...
        component: () =>
            import ('../views/CameraManagement.vue'),
    ...
    },
    {
        ...
        component: () =>
            import ('../views/ForensicAnalysis.vue'),
    ...
    },
    {
        ...
        meta: { title: 'Forgot Password', requiresAuth: false, layout: 'auth' }
    },
    {
        ...
        meta: { title: 'Reset Password', requiresAuth: false, layout: 'auth' }
    },
    {
        path: '/:pathMatch(.*)*',
        name: 'NotFound',
